...
namespace CozmicVoid.Content.Items.Materials
{
    ...
    public class RevengeConstruct : ModItem
    {
        ...
        public override void PostDrawInWorld(SpriteBatch spriteBatch, Color lightColor, Color alphaColor, float rotation, float scale, int whoAmI)
        {
            ...
            DrawHelper.DrawGlow2InWorld(this.Item, spriteBatch, ref rotation, ref scale, whoAmI);
            if (Main.rand.NextBool(20))
            {
                Dust dust = Main.dust[Dust.NewDust(new Vector2(Item.position.X, Item.position.Y), 20, 26, 43, Item.velocity.X, Item.velocity.Y, 100, Color.Pink, Main.rand.NextFloat(.2f, .4f))];
                dust.velocity *= 0f;
                dust.noGravity = true;
                dust.fadeIn = 1.3f;
            }
            ...
            Texture2D texture = (Texture2D)Mod.Assets.Request<Texture2D>("Content/Items/Materials/RevengeConstruct_Glow");
