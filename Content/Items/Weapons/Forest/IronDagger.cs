...
namespace CozmicVoid.Content.Items.Weapons.Forest
{
    ...
    public class IronDagger : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.autoReuse = true;
            Item.shootSpeed = 22;
            Item.shoot = ModContent.ProjectileType<IronDaggerProj>();
        }
    ...
    public class IronDaggerProj : ModProjectile, IPixelatedPrimitiveRenderer
    {
        ...
        public float IceTailWidthFunction(float completionRatio)
        {
            ...
            float tipSmoothenFactor = MathF.Sqrt(1f - InverseLerp(0.25f, 0.03f, completionRatio).Cubed());
            return Projectile.scale * baseWidth * tipSmoothenFactor;
        }

        public Color IceTailColorFunction(float completionRatio)
        {
            Color color = Color.Lerp(Color.White, Color.Gray, InverseLerp(0.2f, 0.67f, completionRatio));
        ...
        public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
        {
            ...
            PrimitiveSettings settings = new PrimitiveSettings(IceTailWidthFunction, IceTailColorFunction, _ => Projectile.Size * 0.1f + (Projectile.rotation - MathHelper.PiOver2).ToRotationVector2() * Projectile.scale * 0f, Shader: iceTailShader, Pixelate: true);
        ...
        public override void PostDraw(Color lightColor)
        {
            ...
            Texture2D texture = (Texture2D)Mod.Assets.Request<Texture2D>("Content/Items/Weapons/Forest/IronDaggerProj");
