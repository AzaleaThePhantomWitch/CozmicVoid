...
{
    internal class StarFlare : ModProjectile
    {
        float TrailSize;
        float StarSpeed;
        int StarType;
        ...
        public override void OnSpawn(IEntitySource source)
        {
            ...
            Projectile.scale = 0f;
            Main.LocalPlayer.GetModPlayer<EffectsPlayer>().ShakeAtPosition(Projectile.Center, 700f, 30f);
            ...
            if (StarType == 0)
            {
                SoundEngine.PlaySound(new SoundStyle("CozmicVoid/Assets/Sounds/Npc/StarDreamer_Shot1"));
            }
            else
            {
                SoundEngine.PlaySound(new SoundStyle("CozmicVoid/Assets/Sounds/Npc/StarDreamer_Shot2"));
            }
        }
