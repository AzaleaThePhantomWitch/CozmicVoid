...
{
    public class MoonTechBrickT : ModTile
    {
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<MoonTechBrick>());
        }
    ...
    public class MoonTechBrick : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.createTile = ModContent.TileType<MoonTechBrickT>();
