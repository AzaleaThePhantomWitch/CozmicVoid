...
namespace CozmicVoid.Dusts
{
    public class GlowDust : ModDust
    {
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(CozmicVoid.Instance.Assets.Request<Effect>("Assets/Effects/GlowingDust", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
        }
